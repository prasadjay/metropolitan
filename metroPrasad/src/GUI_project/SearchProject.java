...
//        }
    ...
    private void initComponents() {
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                .addGap(328, 328, 328)
                .addComponent(btnMore, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        String query1 = "select * from project where pAvailability='YES' AND (pID like '"+k+"' OR pName like '"+k+"') ";
        ...
        if(evt.getKeyCode()>0 && evt.getKeyCode()<200 )
        {
            ...
            else
            {
                ...
                try {
                    ...
                    stmt = con1.prepareStatement("select * from project where pAvailability = 'YES' AND (pID like ? OR pName like ?)");
    ...
    private void btnMoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMoreActionPerformed
        ...
        ViewDetailedProject c = new ViewDetailedProject();
        c.setVisible(true);
